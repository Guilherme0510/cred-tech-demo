     ...
     <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: "Limpa Nome",
              desc: "Eliminamos restrições de crédito nos principais órgãos de proteção ao crédito.",
            },
            {
              title: "Revisão de Juros Abusivos",
              desc: "Analisamos e contestamos juros abusivos cobrados em suas dívidas.",
            },
            {
              title: "Certificado Digital",
              desc: "Oferecemos certificados digitais para facilitar a assinatura eletrônica.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
